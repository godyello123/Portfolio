...
namespace GateServer
{
	...
	{
        private string ConfigPath { get { return "Config/GateServerConfig.xml"; } }
        ...
        public string PlayServerIP { get; set; }
        public string PlayServerDN { get; set; }
        public ushort PlayServerPort { get; set; }
        ...
        public CConfig()
		{
            try
            {
                ...
                RestThreadCount = RestThreadCount <= 0 ? (Environment.ProcessorCount) : RestThreadCount;

                PlayServerIP = genaral.GetAttribute("play_server_id");
                PlayServerDN = genaral.GetAttribute("play_server_dn");
                if (string.IsNullOrEmpty(PlayServerDN)) PlayServerDN = PlayServerIP;
                PlayServerPort = Convert.ToUInt16(genaral.GetAttribute("play_server_port"));
