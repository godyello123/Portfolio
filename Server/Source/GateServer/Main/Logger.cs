...
public class CommonLogger
{
    ...
    {
        GateServer.CLogger.Instance.Error(msg);
    }
    ...
    {
        GateServer.CLogger.Instance.Info(msg);
    }

    public static void Warning(string msg)
    {
        GateServer.CLogger.Instance.Warning(msg);
    }

    public static void System(string msg)
    {
        GateServer.CLogger.Instance.System(msg);
    }
}
