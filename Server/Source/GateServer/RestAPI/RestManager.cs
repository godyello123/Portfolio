...
namespace Global.RestAPI
{
    ...
    class CRestManager : SSingleton<CRestManager>
    {
        ...
        public void RestAuth(long sessionKey, int serverKey, string token)
        {
            Insert(sessionKey, new CRestAuth(sessionKey, serverKey, token));
        }
        ...
        //public void RestIAP(long session, long pcID, string receipt, LogBase log)
        //{
